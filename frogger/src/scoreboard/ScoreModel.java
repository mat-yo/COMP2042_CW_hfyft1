...
public class ScoreModel {
	...
	public Scene getScoreScene(Group group) {
		...
		hs.getStylesheets().add(getClass().getResource("/application/application.css").toExternalForm());
		return hs;
	}
	...
	public Scene getBackMainScene(Pane main) {
		...
		gomain.getStylesheets().add(getClass().getResource("/application/application.css").toExternalForm());
		return gomain;
	}
