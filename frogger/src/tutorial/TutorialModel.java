...
public class TutorialModel {
	...
	public Scene getTut(Pane learn) {
		...
		tut.getStylesheets().add(getClass().getResource("/application/application.css").toExternalForm());
		return tut;
	}
	...
	public Scene getBackMainScene(Pane main) {
		...
		menu.getStylesheets().add(getClass().getResource("/application/application.css").toExternalForm());
		return menu;
	}
